...
class  CSharpPreprocessorParser : public CSharpPreprocessorParserBase {
public:
  enum {
  ...
  explicit CSharpPreprocessorParser(antlr4::TokenStream *input);

  CSharpPreprocessorParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~CSharpPreprocessorParser() override;
  ...
  public:
    ...
    CSharpPreprocessorParser::Preprocessor_expressionContext *expr = nullptr;
  ...
  public:
    String value;
    CSharpPreprocessorParser::Preprocessor_expressionContext *expr1 = nullptr;
    CSharpPreprocessorParser::Preprocessor_expressionContext *expr = nullptr;
    CSharpPreprocessorParser::Preprocessor_expressionContext *expr2 = nullptr;
