...
class  CSharpParser : public CSharpParserBase {
public:
  enum {
  ...
  CSharpParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~CSharpParser() override;
