...
public:
  ...
  public:
    myParser::Primary_expression_startContext *pe = nullptr;
  ...
  public:
    myParser::Qualified_identifierContext *qi = nullptr;
  ...
  public:
    myParser::AttributesContext *attrs = nullptr;
    myParser::Accessor_modifierContext *mods = nullptr;
  ...
  bool local_variable_declarationSempred(Local_variable_declarationContext *_localctx, size_t predicateIndex);
