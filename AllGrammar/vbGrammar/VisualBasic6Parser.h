...
public:
  ...
  enum {
    ...
    RuleSubscript_ = 138, RuleAmbiguousIdentifier = 139, RuleAsTypeClause = 140, 
    ...
    RulePublicPrivateGlobalVisibility = 150, RuleType_ = 151, RuleTypeHint = 152, 
    RuleVisibility = 153, RuleAmbiguousKeyword = 154, RuleIntegerLiteral = 155, 
    RuleOctalLiteral = 156, RuleDoubleLiteral = 157
  };

  explicit VisualBasic6Parser(antlr4::TokenStream *input);

  VisualBasic6Parser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~VisualBasic6Parser() override;
  ...
  class  VsMultDivContext : public ValueStmtContext {
  public:
    VsMultDivContext(ValueStmtContext *ctx);
  ...
  class  VsAddSubContext : public ValueStmtContext {
  public:
    VsAddSubContext(ValueStmtContext *ctx);
  ...
  class  VsPlusMinusContext : public ValueStmtContext {
  public:
    VsPlusMinusContext(ValueStmtContext *ctx);
  ...
  class  VsIDivContext : public ValueStmtContext {
  public:
    VsIDivContext(ValueStmtContext *ctx);
  ...
  class  VsCompContext : public ValueStmtContext {
  public:
    VsCompContext(ValueStmtContext *ctx);
